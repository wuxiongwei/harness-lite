...
description: |
  ...
  "先看看长什么样"，或刚做完 /harness-design 想在编码前验证方向。
---

# /harness-prototype · 原型生成 skill

> **路径A · 设计后可选环节**：把需求/设计翻译为可点击的 HTML 原型
...
**何时用**：路径A 完成 02-设计后，方向上还有不确定 / 需要给非技术干系人看 / 客户要"先看看样子"。
**何时不用**：路径B/C（小需求、bug 修复），需求已经非常明确无需可视化验证。
...
*Harness-Lite · /harness-prototype · 路径A 设计后可选环节 · 提取自 ccflow prototype workflow*
